...
const Room = () => {
  ...
  const SOCKET_URL = 'https://aptitude-game-site-backend-wdo1.onrender.com';
  const API_BASE = 'https://aptitude-game-site-backend-wdo1.onrender.com';
  ...
  useEffect(() => {
    ...
    // Load saved defaults
    api.get(`/settings/${encodeURIComponent(displayName)}`)
      .then((s) => {
        if (s) {
  ...
  return (
    <div className="room">
      <header>
        ...
        <button className="logout" onClick={() => navigate('/dashboard')}>Logout</button>
      </header>
                ...
                {showFinalResults && (
                  <div className="final-results">
                    ...
                    <div className="results-footer">
                      ...
                      <button className="play-again" onClick={() => setShowFinalResults(false)}>
                        Play Again
                      </button>
                    </div>
                  </div>
